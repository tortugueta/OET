# TODO: Make the mouse event apply only to a certain scene
...
class GraphicsWindow(QDialog, graphics_window.Ui_GraphicsWindow):
	...
	def mousePressEvent(self, event):
		...
		currentScene = self.graphicsView.scene()
		sceneCoordinates = self.graphicsView.mapToScene(event.pos())
		
		strokeWidth = 30
		pen = QPen(Qt.white, strokeWidth)
		radius = 15
		circle = QGraphicsEllipseItem(sceneCoordinates.x() - radius, sceneCoordinates.y() - radius, radius * 2, radius * 2)
		circle.setPen(pen)
